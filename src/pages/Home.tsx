    ...
    <div className="min-h-screen bg-white flex flex-col justify-center items-center text-gray-800">
      ...
      <div className="mb-10">
        ...
        <div className="flex flex-col space-y-4">
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="border border-gray-300 p-4 rounded-lg shadow-md bg-white transition-transform transform hover:scale-105 duration-300"
            >
      ...
      <div className="mb-10">
        ...
        <div className="flex justify-center">
          <input
            ...
            className="p-2 border border-gray-300 rounded-l-md bg-white text-gray-800"
          />
      ...
      <footer className="text-sm text-gray-600">
        <p>
          Contáctanos en:{' '}
          <a
            href="mailto:support@powerboost.com"
            className="text-gray-800 underline"
          >
            support@powerboost.com
          </a>
        </p>
...
const products = [
  {
    ...
    image:
      'https://imgs.search.brave.com/-ZTG7XwD1YuY5HySy6QykjX76je4POL9lPIZSB8lsGg/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9kb2pp/dzJtOXR2djA5LmNs/b3VkZnJvbnQubmV0/LzI2NDE1L3Byb2R1/Y3QvWF92ZW5vbS1j/YW5keTUwMjMuanBn/PzE5NzQmdGltZT0x/NzM2ODMyMTk1',
  },
  {
    id: 2,
    name: 'Energy Max',
    ...
    image:
      'https://imgs.search.brave.com/JUE31ejjKFk8lBQay_Z-d7OCGNavGND-sCHy3bRyH_A/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9lc3Nl/bnRpYWxzbXguY29t/L2Nkbi9zaG9wL2Zp/bGVzL2JjYWFfX19t/b3JhX2F6dWxfNGQ1/ODU1MTktNDY4OC00/NjhhLWFkNWEtN2U1/ZjMwNTc0NzAyLmpw/Zz92PTE3MjE3Njg5/MDgmd2lkdGg9MTUw/MA',
  },
  {
    id: 3,
    name: 'Recovery Pro',
    ...
    image:
      'https://imgs.search.brave.com/8BbpUZc2oZNrEuyeubODm4yUdQCjlPgIiiPf1gZ_ZPs/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL0kv/NzFFV1ktZERFM0wu/anBn',
  },
];
